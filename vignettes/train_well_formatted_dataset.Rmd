...
It is indicated that the 95% CI of the HR is missing. Again, even if the information is present in the dataset, the function is missing it because the column names regarding the value of the effect size and its 95% confidence interval (CI) are not appropriate.
