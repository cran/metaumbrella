---
title: "Conducting umbrella reviews with metaumbrella: an introduction"
...
output: 
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{Conducting umbrella reviews with metaumbrella: an introduction}
...
<li>
assesses excess significance bias using the Ioannidis' test.
</li>
<li>
...
<ul>
<li>
Ioannidis: this criteria strictly applies the guidelines described by Fusar-Poli & Radua (2018).
</li>
...
<li> <b>egger_p</b>: a p-value of an Egger's test for publication bias. If the p-value of the Egger's test is strictly superior to the threshold value indicated in this egger_p criteria, the class for which this value is indicated can be reached.</li>
<li> <b>esb_p</b>: a p-value of an Ioannidis' test for the excess of significance bias (ESB). If the p-value of the Ioannidis' test is strictly superior to the threshold value indicated in this esb_p criteria, the class for which this value is indicated can be reached.</li>
...
For the publication bias, we set the following criteria:
